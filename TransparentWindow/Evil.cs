...
namespace TransparentWindow
{
    ...
    public static class TextureUtils
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        private static extern unsafe int D3DXLoadSurfaceFromMemory(
            void* pDestSurface,
            void* pDestPalette,
            RECT* pDestRect,
            void* pSrcMemory,
        ...
        private static readonly FieldInfo pComPtr;

        static TextureUtils()
        {
            pComPtr = typeof(Texture2D).GetField("pComPtr", BindingFlags.Instance | BindingFlags.NonPublic);
        }
        ...
        private static unsafe void* GetIDirect3DTexture9(this Texture2D texture)
        {
        ...
        private static unsafe void* AccessVTable(void* pInterface, uint offsetInBytes)
        {
        ...
        private static unsafe void* GetSurfaceLevel(this Texture2D texture, int level)
        {
        ...
        public static unsafe void SetData(
            ...
            RECT destRect, uint pitch, RECT sourceRect,
            D3DFORMAT pixelFormat
            )
        {
            void* pSurface = texture.GetSurfaceLevel(level);
            RECT* pDestRect = &destRect;
            RECT* pSourceRect = &sourceRect;
